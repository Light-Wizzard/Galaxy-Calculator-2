...
PyObject *mpreal_str(PyObject *self)
{
    ...
    return PyUnicode_FromString(NumberFormat::toDecimal(v, mpfr::bits2digits(v.getPrecision()),
...
/************************************************
 * @brief mpreal set default precision.
 * mpreal_set_default_precision
 ***********************************************/
PyObject *mpreal_set_default_precision(PyMpRealObject *self, PyObject *args)
{
    Q_UNUSED(self)
...
/************************************************
 * @brief mpreal get default precision.
 * mpreal_get_default_precision
 ***********************************************/
PyObject *mpreal_get_default_precision(PyMpRealObject *self, PyObject *args)
{
    Q_UNUSED(self)
...
/************************************************
 * @brief mpreal set default rounding.
 * mpreal_set_default_rounding
 ***********************************************/
PyObject *mpreal_set_default_rounding(PyMpRealObject *self, PyObject *args)
{
    Q_UNUSED(self)
...
/************************************************
 * @brief mpreal get default rounding.
 * mpreal_get_default_rounding
 ***********************************************/
PyObject *mpreal_get_default_rounding(PyMpRealObject *self, PyObject *args)
{
    Q_UNUSED(self)
