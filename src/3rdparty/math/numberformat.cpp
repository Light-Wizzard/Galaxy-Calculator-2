...
/************************************************
 * @brief get Rounding Format Char.
 * getRoundingFormatChar
 ***********************************************/
...
{
    return v.toString("%." + std::to_string(decimalSpaces) + "R" + getRoundingFormatChar(rounding) + "a");
}
/************************************************
 * @brief to Octal.
 * toOctal
