...
class MainWindow : public QMainWindow
{
    ...
    public:
        ...
        bool readSettings();                                                //!< ReadSettings
        bool writeSettingsDbMemory(const QString thisDbMemory);             //!< writeSettingsDbMemory
        ...
        bool setSettingsCombo();                                            //!< setSettingsCombo
        bool setPlanetCombo();                                              //!< setPlanetCombo
        ...
        bool setCalcConstantCombo();                                        //!< setCalcConstantCombo
    ...
    private slots:
        ...
        void on_checkBoxSettingsMemory_stateChanged(int arg1);                      //!< Memory state Changed
    ...
    private:
        ...
        GalaxyDataTable          *myGalaxyModel;                            //!< \c myGalaxyModel \brief Pointer to DataTable GalaxyModel
        QSqlRelationalTableModel *UniverseModel;                            //!< \c UniverseModel \brief
        GalaxySettings           *myGalaxySettings;                         //!< \c myGalaxySettings \brief
        TrinaryMath              *myTrinaryMath;                            //!< \c myGalaxySettings \brief Trinary Math
        QSqlDatabase              myDb;                                     //!< \c myDb \brief Database

        const QString             myDbMemory = "DbMemory";                  //!< \c myDbMemory \brief Sql Driver DbMemory
        const QString             myCalcDecimal = "CalcDecimal";            //!< \c myCalcDecimal \brief Sql Driver CalcDecimal

        QString                   myLivePlanetRingFreq;                     //!< \c myLivePlanetRingFreq \brief
        ...
        bool                      isMainLoaded = false;                     //!< \c isDebugMessage \brief  true of false
        bool                      isDbMemory;                               //!< \c isDbMemory \brief
        bool                      isSaveSettings=false;                     //!< \c isSaveSettings \brief
        bool                      isTableLoaded=false;                      //!< \c isTableLoaded \brief
        bool                      isGalaxyTableViewSize=false;              //!< \c isGalaxyTableViewSize \brief
        // Part of Math
        SymbolTable               mySymbolTable;                            //!< \c symbolTable \brief
        Settings                  mySettings;                               //!< \c settings \brief
        int                       myCount;                                  //!< \c myCount \brief
        ...
        int                       myEnergyEnergy=100;                       //!< \c myEnergyEnergy \brief
        int                       myEnergyCurrent=66;                       //!< \c myEnergyCurrent \brief myEnergyCurrent
};
#endif // MAINWINDOW_H
/*** ************************* End of File ***********************************/
