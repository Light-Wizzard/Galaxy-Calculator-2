...
#include "3rdparty/extern/exprtk.hpp"

#include "3rdparty/math/scripthandler.hpp"
...
struct ScriptFunction : public exprtk::ifunction<T>
{
        ...
        ScriptFunction() : exprtk::ifunction<T>(0), callback(nullptr) {}

        explicit ScriptFunction(PyObject *callback) : exprtk::ifunction<T>(0), callback(callback) {}
