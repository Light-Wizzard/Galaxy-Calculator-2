...
#include "3rdparty/extern/json.hpp"
/******************************************************************************
* \fn Function
*******************************************************************************/
struct Function
{
    ...
    Function(std::string expression, std::vector<std::string> arguments) : expression(std::move(expression)), argumentNames(std::move(arguments)) {}
